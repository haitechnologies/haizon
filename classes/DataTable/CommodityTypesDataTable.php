...
class CommodityTypesDataTable extends BaseDataTable {
    ...
    protected $sortableColumns = [0 => 'id', 1 => 'commodity_type', 2 => 'created_at', 3 => 'publish', 4 => 'id'];
    ...
    protected function getActionButtons($id, $module) {
        $a = '';
        if (granted_('edit', $module))   $a .= ActionButtonHelper::editButton((int)$id, 'commodity_types.php', $module, 'Edit', false);
