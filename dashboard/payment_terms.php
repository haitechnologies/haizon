...
$module_caption     = 'Payment Term';
$tbl_name = DB::PAYMENT_TERMS;
$error_message         = '';
$success_message     = '';
...
if ($action == "update_$module" && !empty($id) && granted('edit', $module_id)) {
    ...
    if (empty($payment_term)) {
        $error_message = 'Payment term is mandatory.';
    } else if (checkDuplicateRow($tbl_name, 'payment_term', $payment_term) && $payment_term != getTableAttr('payment_term', $tbl_name, $id)) {
        $error_message = 'Duplicate Payment term. Please enter different.';
    } else {
...
*/
    ...
    if (empty($payment_term)) {
        $error_message = 'Payment term is mandatory.';
    } else if (checkDuplicateRow($tbl_name, 'payment_term', $payment_term)) {
        $error_message = 'Payment term already exists. Please enter a different one.';
    } else {

        $insert_row = $mysqli->query("INSERT INTO `$tbl_name`(payment_term, is_active) VALUES ('" . $payment_term . "', '" . $publish . "'); ");
            ...
            <form class="steps-basic clearfix" method="post" id="frm<?php echo $module; ?>" name="frm<?php echo $module; ?>" action="<?php echo $module; ?>.php" enctype="multipart/form-data">
                ...
                <div class="card col-lg-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label"><span class="text-danger">Payment term:*</span></label>

                            <div class="col-lg-9">
                                <input required type="text" name="payment_term" id="payment_term" value="<?php echo $payment_term; ?>" class="form-control">
                            </div>
                        </div>
