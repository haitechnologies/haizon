...
$module_caption     = 'Container Type';
$tbl_name = DB::CONTAINER_TYPES;
$error_message         = '';
$success_message     = '';
...
if ($action == "update_$module" && !empty($id) && granted('edit', $module_id)) {
    ...
    if (empty($container_type)) {
        $error_message = 'Container type is mandatory.';
    } else if (checkDuplicateRow($tbl_name, 'container_type', $container_type) && $container_type != getTableAttr('container_type', $tbl_name, $id)) {
        $error_message = 'Duplicate Container type. Please enter different.';
    } else {
...
*/
    ...
    if (empty($container_type)) {
        $error_message = 'Container type is mandatory.';
    } else if (checkDuplicateRow($tbl_name, 'container_type', $container_type)) {
        $error_message = 'Duplicate Container type. Please enter different.';
    } else {

        $insert_row = $mysqli->query("INSERT INTO `$tbl_name`(container_type, description, is_active) VALUES ('" . $container_type . "', '" . $description . "', '" . $publish . "'); ");
        ...
        <!-- Page header -->
                ...
                <div class="card col-lg-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label"><span class="text-danger">Container Type: *</span></label>

                            <div class="col-lg-9">
                                <input required type="text" name="container_type" id="container_type" value="<?php echo $container_type; ?>" class="form-control">
                            </div>
                        </div>
