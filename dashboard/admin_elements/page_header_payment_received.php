...
<div class="page-header page-header-light shadow">
    ...
    <div class="row"><div class="row mb-1"><div class="col-lg-12 d-flex align-items-center">
        <?php if (isset($module_id) && granted('edit', $module_id)) { ?>
            <a href="<?php echo $module; ?>.php?action=edit_<?php echo $module; ?>&id=<?php echo $payment_received_id; ?>" class="btn btn-light btn-sm me-2 ms-1"><i class="ph-pencil"></i> Edit</a>
        <?php } ?>
