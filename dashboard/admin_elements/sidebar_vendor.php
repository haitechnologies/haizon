...
if (!isset($_SESSION["vendors_ordering"])) $_SESSION["vendors_ordering"] = "all";
...
?>
    <tr id="<?php echo $row["id"]; ?>" class="<?php echo $sel; ?>">
        <td><a href="vendor_overview.php?vendor_id=<?php echo $row["id"]; ?>" class="text-black text-decoration-none d-block">
            <?php echo $name; ?>
        </a></td>
    </tr>
<?php } ?>
