    ...
    <form class="steps-basic clearfix" method="post" id="frm<?php echo $module; ?>" name="frm<?php echo $module; ?>" action="<?php echo $module; ?>.php" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="breadcrumb py-2">
                        ...
                        <a href="listing_<?php echo $module; ?>.php" class="breadcrumb-item">System User</a>
        ...
        <div class="content-inner">
            <div class="content">
                ...
                <h1 class="mb-3"><?php if (($action == "edit_$module" || $action == "update_$module") && !empty($id)) { ?>Edit<?php } else { ?>New<?php } ?> Role</h1>

                <?php if ($action != "edit_$module" && $action != "update_$module" && empty($id)) { ?>
                <div class="alert alert-info border-0 alert-dismissible fade show">
                    <i class="ph-info me-2"></i>
                    <strong>Info:</strong> Create a new role and assign specific module permissions. Only <strong>Super Admin</strong> can access this module.
