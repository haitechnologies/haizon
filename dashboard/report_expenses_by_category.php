...
$result         = $mysqli->query("SELECT COUNT(DISTINCT 'General') as category_count FROM `fls_expenses` e WHERE e.id>0 " . $expense_search_query);
            ...
            <div class="page-header-content">
                ...
                <div class="row mt-2">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-0">
                            <span class="fw-semibold">Expense by Category</span> - <span class="small">From <?php echo dd_($date_from); ?> To <?php echo dd_($date_to); ?></span>
                        </div>
                    </div>
