			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-sm-6 col-xl-3">
						<div class="card card-body" onclick="window.location.href='listing_quotations.php';" style="cursor: pointer;">
							<div class="d-flex align-items-center mb-3">
								<i class="ph-file-text ph-2x text-primary opacity-75 me-3"></i>
								<div class="flex-fill">
									<h6 class="mb-0">Quotations</h6>
									<span class="text-muted fs-sm">This Month</span>
								</div>
								<?php if ($quotations_growth != 0): ?>
									<span class="badge <?php echo $quotations_growth > 0 ? 'bg-success' : 'bg-danger'; ?> rounded-pill ms-2">
							...
							<div class="d-flex align-items-end">
								<h3 class="mb-0 me-auto"><?php echo $quotations_this_month; ?></h3>
								<span class="text-muted">/ <?php echo $total_quotations; ?> total</span>
							</div>
							<div class="progress mt-2" style="height: 4px;">
								<div class="progress-bar bg-primary" style="width: <?php echo $total_quotations > 0 ? ($quotations_approved / $total_quotations * 100) : 0; ?>%"></div>
							</div>
							<small class="text-muted mt-1"><?php echo $quotations_approved; ?> approved, <?php echo $quotations_pending; ?> pending</small>
						</div>
					</div>

					<!-- Sale Orders Card -->
					<div class="col-sm-6 col-xl-3">
						<div class="card card-body" onclick="window.location.href='listing_sale_orders.php';" style="cursor: pointer;">
							<div class="d-flex align-items-center mb-3">
								<i class="ph-shopping-cart ph-2x text-success opacity-75 me-3"></i>
								<div class="flex-fill">
									<h6 class="mb-0">Sale Orders</h6>
									<span class="text-muted fs-sm">This Month</span>
								</div>
							</div>
							<div class="d-flex align-items-end">
								<h3 class="mb-0 me-auto"><?php echo $sale_orders_this_month; ?></h3>
								<span class="text-muted">/ <?php echo $total_sale_orders; ?> total</span>
							</div>
							<div class="progress mt-2" style="height: 4px;">
								<div class="progress-bar bg-success" style="width: <?php echo $total_sale_orders > 0 ? ($sale_orders_confirmed / $total_sale_orders * 100) : 0; ?>%"></div>
							</div>
							<small class="text-muted mt-1"><?php echo $sale_orders_confirmed; ?> confirmed, <?php echo $sale_orders_pending; ?> pending</small>
						</div>
					</div>

					<!-- Jobs Card -->
					<div class="col-sm-6 col-xl-3">
						<div class="card card-body" onclick="window.location.href='listing_jobs.php';" style="cursor: pointer;">
							<div class="d-flex align-items-center mb-3">
								<i class="ph-briefcase ph-2x text-info opacity-75 me-3"></i>
								<div class="flex-fill">
									<h6 class="mb-0">Active Jobs</h6>
									<span class="text-muted fs-sm">In Progress</span>
								</div>
							</div>
							<div class="d-flex align-items-end">
								<h3 class="mb-0 me-auto"><?php echo $jobs_active; ?></h3>
								<span class="text-muted">/ <?php echo $total_jobs; ?> total</span>
							</div>
							<div class="progress mt-2" style="height: 4px;">
								<div class="progress-bar bg-info" style="width: <?php echo $total_jobs > 0 ? ($jobs_active / $total_jobs * 100) : 0; ?>%"></div>
							</div>
							<small class="text-muted mt-1"><?php echo $jobs_this_month; ?> created this month</small>
						</div>
					</div>
					...
					<div class="col-sm-6 col-xl-3">
						<div class="card card-body bg-primary text-white">
							<div class="d-flex align-items-center mb-3">
								<i class="ph-currency-circle-dollar ph-2x opacity-75 me-3"></i>
								<div class="flex-fill">
									<h6 class="mb-0">Revenue</h6>
									<span class="opacity-75 fs-sm">This Month</span>
								</div>
							...
							<div class="d-flex align-items-end">
								<h3 class="mb-0 me-auto"><?php echo number_format($current_month_revenue, 0); ?></h3>
							</div>
							<div class="progress mt-2 bg-white bg-opacity-20" style="height: 4px;">
								<div class="progress-bar bg-white" style="width: <?php echo $total_revenue > 0 ? ($current_month_revenue / $total_revenue * 100) : 0; ?>%"></div>
							</div>
							<small class="opacity-75 mt-1"><?php echo number_format($total_revenue, 0); ?> total revenue</small>
						</div>
					</div>
				</div>
					...
					<div class="col-xl-4">
						...
						<div class="row">
							<div class="col-sm-6 col-xl-12">
								<div class="card card-body bg-success text-white" onclick="window.location.href='listing_shipping_advices.php';" style="cursor: pointer;">
									<div class="d-flex align-items-center">
										<i class="ph-package ph-3x opacity-75 me-3"></i>
										<div class="flex-fill">
											<h3 class="mb-1"><?php echo $total_shipping_advices; ?></h3>
											<div class="opacity-75">Delivery Advices</div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6 col-xl-12">
								<div class="card card-body bg-primary text-white" onclick="window.location.href='listing_hscodes.php';" style="cursor: pointer;">
									<div class="d-flex align-items-center">
										<i class="ph-barcode ph-3x opacity-75 me-3"></i>
										<div class="flex-fill">
											<h3 class="mb-1"><?php echo $total_hscodes; ?></h3>
											<div class="opacity-75">HS Codes</div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="card">
							...
							<div class="list-group list-group-flush">
								<a href="listing_ports.php" class="list-group-item list-group-item-action d-flex align-items-center">
									...
									<span class="badge bg-primary bg-opacity-20 text-primary rounded-pill"><?php echo $total_ports; ?></span>
								</a>
								<a href="listing_carriers.php" class="list-group-item list-group-item-action d-flex align-items-center">
									...
									<span class="badge bg-success bg-opacity-20 text-success rounded-pill"><?php echo $total_carriers; ?></span>
								</a>
								<a href="listing_container_types.php" class="list-group-item list-group-item-action d-flex align-items-center">
									...
									<span class="badge bg-info bg-opacity-20 text-info rounded-pill"><?php echo $total_containers; ?></span>
								</a>
							</div>
						</div>
