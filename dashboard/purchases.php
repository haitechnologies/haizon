        ...
        <div class="page-header-content border-top py-2 px-3 carriers-page-header-content">
            <div class="my-1 d-flex align-items-center gap-2">
                ...
                <?php if (($action == "edit_$module" || $action == "update_$module") && !empty($id)) { ?>
                    <span class="text-muted small fw-semibold ms-2">Purchase #: <?php echo $purchase_no; ?></span>
                <?php } ?>
            ...
            <div class="my-1">
                <?php if (isset($module_id) && granted('create', $module_id)) { ?>
                    <button type="button" onclick="document.getElementById('purchase_status').value='draft'; document.getElementById('frm<?php echo $module; ?>').submit();" class="btn btn-primary btn-sm me-2">Save as Draft</button>
                    <button type="button" onclick="document.getElementById('save_and_send').value='1'; document.getElementById('purchase_status').value='draft'; document.getElementById('frm<?php echo $module; ?>').submit();" class="btn btn-info btn-sm me-2">Save and Send</button>
                <?php } ?>
                <?php if (!empty($id)) { ?>
