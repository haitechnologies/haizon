...
function complete_dashboard_login($row, $client_ip, $project_pre)
{
    ...
    $_SESSION[$project_pre]['DASHBOARD']['role_id'] = (int)$row['role_id'];
    $_SESSION[$project_pre]['DASHBOARD']['user_id'] = (int)$row['id'];
...
if (!empty(Session::userId())) {
    $redirectTo = $_SESSION[$project_pre]['DASHBOARD']['redirect_to'] ?? 'index.php';
