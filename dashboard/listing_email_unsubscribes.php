...
$module = 'email_unsubscribes';
$module_id = getModuleIdBySlug($module, $mysqli);
$module_caption = 'Email Unsubscribes';
$tbl_name = DB::EMAIL_UNSUBSCRIBES;
$error_message = '';
$success_message = '';
...
$(document).ready(function() {
    ...
    window.HAIDatatableInitializer.init(tableSelector, '<?php echo $module; ?>', {
        ...
        ajax: {
            ...
            error: function() {
                $('.grid-error').html('');
                $(tableSelector).append('<tbody class="grid-error"><tr><th colspan="4">No Results Found.</th></tr></tbody>');
