...
<div class="content-wrapper">
    ...
    <div class="page-header page-header-light shadow">
        <div class="page-header-content d-lg-flex border-top">
            <div class="row mt-2">
                <div class="col-lg-12">
                    <h5 class="ms-2 mb-0"> <a href="listing_<?php echo $module; ?>.php" class="text-dark">All Shipping Stocks - History</a></h5>
                </div>
            ...
            <?php if (isset($module_id) && granted('create', $module_id)) { ?>
                <div class="collapse d-lg-block ms-lg-auto" id="breadcrumb_elements">
                    <div class="d-lg-flex mb-2 mb-lg-0">
                        <button type="button" class="btn btn-primary btn-sm mt-1 mb-1" onclick="window.location.href='listing_shipping_advice_items.php';"><i class="ph-plus ph-sm me-2 opacity-75"></i>New</button>
                    </div>
                </div>
            <?php } ?>
