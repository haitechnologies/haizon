...
$(document).ready(function() {
    window.HAIDatatableInitializer.init('#grid-<?php echo $module; ?>', '<?php echo $module; ?>', {
        ...
        columnDefs: [
            {
                ...
                render: function(data, type, row) {
                    if (type === 'display') {
                        var id = row[6];
                        return '<a href="quotation_overview.php?quotation_id=' + id + '" class="text-primary fw-semibold">' + data + '</a>';
                    }
                    return data;
                }
            }
        ...
        language: { search: '', searchPlaceholder: 'Search quotations...', lengthMenu: '_MENU_' }
    });
});
</script>
