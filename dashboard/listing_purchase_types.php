...
if (($action == "delete_$module" && !empty($id)) && granted('delete', $module_id)) {
    ...
    if (is_SuperAdmin()) {
        ...
        $mysqli->query("DELETE FROM `$tbl_name` WHERE id=$id AND context='purchase' AND created_by ='" . $session_user_id . "'");
    }
...
$(document).ready(function() {
    window.HAIDatatableInitializer.init('#grid-<?php echo $module; ?>', '<?php echo $module; ?>', {
        ...
        language: { search: '', searchPlaceholder: 'Search purchase types...', lengthMenu: '_MENU_' }
    });
});
</script>
