...
$module = 'email_bounces';
$module_id = getModuleIdBySlug($module, $mysqli);
$module_caption = 'Email Bounces';
$tbl_name = DB::EMAIL_BOUNCES;
$error_message = '';
$success_message = '';
...
$(document).ready(function() {
    ...
    window.HAIDatatableInitializer.init(tableSelector, '<?php echo $module; ?>', {
        ...
        ajax: {
            ...
            error: function() {
                $('.grid-error').html('');
                $(tableSelector).append('<tbody class="grid-error"><tr><th colspan="5">No Results Found.</th></tr></tbody>');
