                ...
                <div class="card col-lg-6">
                    <div class="card-body clearfix">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input required type="text" name="code" value="<?php echo htmlspecialchars($code); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Old Code:</label>
                            <div class="col-lg-9">
                                <input type="text" name="old_code" value="<?php echo htmlspecialchars($oldCode); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Level:</label>
                            <div class="col-lg-9">
                                <input type="number" name="level" value="<?php echo $level; ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Duty Rate:</label>
                            <div class="col-lg-9">
                                <input type="text" name="duty_rate" value="<?php echo htmlspecialchars($dutyRate); ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
