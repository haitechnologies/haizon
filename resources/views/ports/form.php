                ...
                <div class="card col-lg-6">
                    <div class="card-body clearfix">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input required type="text" name="port_name" value="<?php echo htmlspecialchars($portName); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label"><span class="text-danger">Port Code:*</span></label>
                            <div class="col-lg-9">
                                <input required type="text" name="port_code" value="<?php echo htmlspecialchars($portCode); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <select required name="country_id" class="form-select">
                                    ...
                                    <?php foreach ($countries as $c) { ?>
                                        <option value="<?php echo $c['id']; ?>" <?php echo (int)$c['id'] === $countryId ? 'selected' : ''; ?>><?php echo htmlspecialchars($c['name']); ?></option>
                                    <?php } ?>
                                </select>
