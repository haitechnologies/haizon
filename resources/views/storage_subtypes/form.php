                ...
                <div class="card col-lg-6">
                    <div class="card-body clearfix">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <select required name="storage_type_id" class="form-select">
                                    <option value="">-- Select Storage Type --</option>
                                    <?php foreach ($allTypes as $cat) { ?>
                                        <option value="<?php echo $type["id"]; ?>" <?php echo (int)$type["id"] === $categoryId ? 'selected' : ''; ?>><?php echo htmlspecialchars($type["storage_type"]); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label"><span class="text-danger">Storage Subtype Name:*</span></label>
                            <div class="col-lg-9">
                                <input required type="text" name="name" value="<?php echo htmlspecialchars($name); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label"><span class="text-danger">Slug:*</span></label>
                            <div class="col-lg-9">
                                <input required type="text" name="slug" value="<?php echo htmlspecialchars($slug); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="icon" value="<?php echo htmlspecialchars($icon); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Meta Title:</label>
                            <div class="col-lg-9">
                                <input type="text" name="meta_title" value="<?php echo htmlspecialchars($metaTitle); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Meta Description:</label>
                            <div class="col-lg-9">
                                <textarea class="form-control" name="meta_description" style="field-sizing: content;"><?php echo htmlspecialchars($metaDescription); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
