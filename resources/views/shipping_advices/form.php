    ...
    <div class="page-header page-header-light shadow carriers-page-header">
        <div class="page-header-content border-top py-2 px-3 carriers-page-header-content">
            <div class="my-1 d-flex align-items-center gap-3">
                ...
                <?php if ($id > 0): ?>
                    <span class="badge bg-light text-dark border fw-semibold">Invoice #: <?php echo $awb_no; ?></span>
                <?php endif; ?>
            </div>
            <div class="my-1">
            ...
            <form class="steps-basic clearfix" method="post" id="frm<?php echo $module; ?>" name="frm<?php echo $module; ?>" action="<?php echo $module; ?>.php" enctype="multipart/form-data">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="row p-lg-2">
                        <div class="col-lg-2">
                            <div class="mb-3">
                                <label class="form-label fw-semibold">AWB No:</label>
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Mirsal II Code:</label>
