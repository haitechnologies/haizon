...
<div class="content-wrapper">
    <div class="page-header page-header-light shadow carriers-page-header">
        <div class="page-header-content border-top py-2 px-3 carriers-page-header-content">
            ...
            <div class="my-1 d-flex align-items-center gap-2">
                <?php if ($canCreate): ?>
                    <?php if ($id > 0): ?>
                        <button type="button" form="frmlead_quotations" class="submit-form btn btn-primary btn-sm">Save</button>
                    <?php else: ?>
                        <button type="button" form="frmlead_quotations" class="save-draft-quotation btn btn-primary btn-sm">Save as Draft</button>
                    <?php endif; ?>
                <?php endif; ?>
                <?php if ($id > 0): ?>
                    <a href="lead_quotation_overview.php?quotation_id=<?php echo $id; ?>" class="btn btn-light btn-sm">Cancel</a>
                <?php else: ?>
    ...
    <div class="content-inner">
        <div class="content">
            ...
            <form class="steps-basic clearfix" method="post" id="frmlead_quotations" name="frmlead_quotations" action="lead_quotations.php" enctype="multipart/form-data">
                ...
                <?php if ($id > 0): ?>
                    <input type="hidden" name="action" id="action" value="update_lead_quotations" />
                    <input type="hidden" name="id" id="id" value="<?php echo $id; ?>" />
                <?php else: ?>
                    <input type="hidden" name="action" id="action" value="add_lead_quotations" />
                <?php endif; ?>
                <?php echo csrf_field(); ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control bg-light" value="<?php echo e_s__($lead_name); ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-9">
                                            <select name="quotation_status_display" id="quotation_status_display" class="form-select" disabled>
                                                <option value="draft" <?php echo $quotation_status === 'draft' ? 'selected' : ''; ?>>Draft</option>
                                                <option value="sent" <?php echo $quotation_status === 'sent' ? 'selected' : ''; ?>>Sent</option>
                                                <option value="accepted" <?php echo $quotation_status === 'accepted' ? 'selected' : ''; ?>>Accepted</option>
                                                <option value="rejected" <?php echo $quotation_status === 'rejected' ? 'selected' : ''; ?>>Rejected</option>
                                                <option value="expired" <?php echo $quotation_status === 'expired' ? 'selected' : ''; ?>>Expired</option>
                                                <option value="confirmed" <?php echo $quotation_status === 'confirmed' ? 'selected' : ''; ?>>Confirmed</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <label class="col-lg-3 col-form-label">Terms & Conditions:</label>
                                        <div class="col-lg-9">
                                            <textarea name="terms_and_conditions" id="terms_and_conditions" class="form-control"><?php echo $terms_and_conditions; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <label class="col-lg-3 col-form-label">Customer Notes:</label>
                                        <div class="col-lg-9">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.submit-form', function(e) {
            e.preventDefault();
            let form = document.getElementById('frmlead_quotations');
            form.submit();
        });
        $(document).on('click', '.save-draft-quotation', function(e) {
            e.preventDefault();
            var form = document.getElementById('frmlead_quotations');
            form.submit();
        });
