...
try {
    ...
    $db->execute(
        "INSERT INTO erp_departments (organization_id, department, publish, created_by) VALUES (:org, 'Test Dept 1', 1, 1)",
        ['org' => $testOrgId]
    );
    $db->execute(
        "INSERT INTO erp_departments (organization_id, department, publish, created_by) VALUES (:org, 'Test Dept 2', 1, 1)",
        ['org' => $testOrgId]
    );
    $db->execute(
        "INSERT INTO erp_departments (organization_id, department, publish, created_by) VALUES (:org, 'Another Dept', 0, 1)",
        ['org' => $testOrgId]
    );
